...
\begin{definition}[Orientable submanifold]\label{def:orientable-subm}
	...
	An \textit{orientation} on a submanifold is then a fixed set of parametrisations $\phi_{i}$ that have positive transition maps. Any orientable submanifold is immediately assigned an orientation, unless specified otherwise. Once a set of parametrisations is chose, the manifold is \textit{oriented}.
\end{definition}
